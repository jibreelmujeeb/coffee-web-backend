...
const adForgotPassword = async (req, res) => {
  ...
  const mailOptions = {
    ...
    text: `You requested a password reset. Click the link to reset your password: https://jibreel.vercel.app/admin/reset-password/${token}`,
    html: `<p>You requested a password reset.</p><p>Click the link below to reset your password:</p><a href="https://jibreel.vercel.app/admin/reset-password/${token}">Reset Password</a>`,
  };
...
const verifyTokenForgotPassword = (req, res) => {
  ...
  res.redirect("https://jibreel.vercel.app/admin/Reset-Password/");
};
